...
public class SwitchPhaseNumberComboBoxEditingCell extends TableCell<SwitchPhase, PhaseNumber>{

	private ComboBox<PhaseNumber> comboBox;
    private RoadPhaseModel roadPhaseModel;

    public SwitchPhaseNumberComboBoxEditingCell(RoadPhaseModel roadPhaseModel){
